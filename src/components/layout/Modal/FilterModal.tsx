    ...
    <div>
      <div className="px-1 flex items-center">
        <div className="pr-2 mr-2">
          <Image className="w-5 h-4" alt="Vector" src={vector} />
        </div>

        <div className="mr-11 font-medium text-base">Фільтр</div>
      </div>
      <div className="flex items-center w-full justify-between mt-10">
        <div className="">ЦІНА</div>

        <div className="" />

        <Image className="" alt="Image" src={arrow} />
      </div>
