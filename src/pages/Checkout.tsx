...
import {
  TFormikValuesCheckout,
  validationSchemaCheckout,
} from "@/lib/validation";
              ...
              <div className={"flex flex-col w-full"}>
                <WrapInput error={formik.errors.payments}>
                  <RadioGroup
                    ...
                    onValueChange={(value) =>
                      formik.setFieldValue("payments", value)
                    }
                  >
                    <div className="flex items-center justify-between w-full py-5 px-6 border border-gray-project-30 rounded-[8px]">
                      ...
                      <div className={"flex gap-3 items-center justify-center"}>
                        <div
                          className={
                            "flex items-center justify-center w-[48px] h-[26px]"
                          }
                        >
                          <Visa />
                        </div>
            ...
            <section className={"gap-5 flex flex-col w-full"}>
              ...
              >
                <Textarea
                  ...
                  maxLength={1000}
                  placeholder={
                    "Примітки щодо вашого замовлення, наприклад вимоги до доставки"
                  }
                />
              </WrapInput>
              <div className={"flex gap-2 items-center w-full"}>
                <Checkbox
                  checked={formik.values.isCall}
                  name={"isCall"}
                  onCheckedChange={(value) =>
                    formik.setFieldValue("isCall", value)
                  }
                />
                <p className={"text-m-1 text-gray-project-90"}>
                  Підтверджую замовлення, не передзвонюйте мені
                </p>
              </div>
            </section>
          </form>
